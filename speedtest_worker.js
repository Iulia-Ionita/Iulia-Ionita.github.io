...
var settings = {
    ...
    url_dl: "fw-speedtest/backend/garbage.xyz", // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: "fw-speedtest/backend/empty.xyz", // path to an empty file, used for upload test. must be relative to this js file
