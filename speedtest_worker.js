...
var settings = {
    ...
    url_dl: "https://de1.backend.librespeed.org/garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: "https://de1.backend.librespeed.org/empty.php", // path to an empty file, used for upload test. must be relative to this js file
