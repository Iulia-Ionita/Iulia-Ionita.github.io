...
var settings = {
    ...
    url_dl: "https://speedtest.de.telekom-vpn.net/download/garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
    url_ul: "https://speedtest.de.telekom-vpn.net/upload/empty.php", // path to an empty file, used for upload test. must be relative to this js file
    ...
    forceIE11Workaround: true //when set to true, it will foce the IE11 upload test on all browsers. Debug only
};
